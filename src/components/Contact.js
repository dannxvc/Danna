        ...
        <Section id="contact">
            ...
            <div className={styles.contact_content}>
                <div  
                    ...
                    style={styleDes}
                >
                    <h3 className={styles.user}>@dannxvc</h3>
                    <p>Feel free to leave a message in any of my socials.</p>
                </div>
                <div className={styles.contact_icons}>
                    <a href="https://github.com/dannxvc" target="_blank" rel="noreferrer">
                        <svg className={styles.icon_contact} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <a href="https://www.linkedin.com/in/dannxvc/" target="_blank" rel="noreferrer">
                        <svg className={styles.icon_contact} data-name="Layer 1" id="Layer_1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title/>
                    ...
                    <a href="https://www.instagram.com/dannxvc/" target="_blank" rel="noreferrer">
                        <svg className={styles.icon_contact} data-name="Layer 1" id="Layer_1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title/>
                            <path fill="var(--icon)" d="M314.757,147.525H197.243a49.717,49.717,0,0,0-49.718,49.718V314.757a49.718,49.718,0,0,0,49.718,49.718H314.757a49.718,49.718,0,0,0,49.717-49.718V197.243A49.717,49.717,0,0,0,314.757,147.525ZM256,324.391A68.391,68.391,0,1,1,324.391,256,68.391,68.391,0,0,1,256,324.391ZM327.242,201.58a16.271,16.271,0,1,1,16.27-16.271A16.271,16.271,0,0,1,327.242,201.58Z"/>
                            <path fill="var(--icon)" d="M256,211.545A44.455,44.455,0,1,0,300.455,256,44.455,44.455,0,0,0,256,211.545Z"/>
                    ...
                    <a href="mailto:dannavila.1809@gmail.com?Subject=Hi!%20I%20Saw%20your%20portfolio!" target="_blank" rel="noreferrer">
                        <svg className={styles.icon_contact} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
