            ...
            <div className="contact-content">
                ...
                <div className="contact-icons">
                    <a href="https://github.com/dannxvc" target="_blank" rel="noreferrer">
                        <svg className="icon-contact" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <a href="https://www.linkedin.com/in/dannxvc/" target="_blank" rel="noreferrer">
                        <svg className="icon-contact" data-name="Layer 1" id="Layer_1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title/>
